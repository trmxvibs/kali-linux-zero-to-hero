...
| `digital-forensics/sample-evidence/` | Module 18 — fabricated evidence files (`document.pdf`, `log_snippet.txt`, `binary_stub`) for file-type, hash, and strings analysis |
